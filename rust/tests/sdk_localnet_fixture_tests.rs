...
use phoenix_rise::{
    ...
    OnboardTraderDelegatedParams, OrderFlags, PhoenixTxBuilder, RegisterTraderParams,
    SelfTradeBehavior, Side, TraderKey,
};
...
async fn rise_sdk_limit_order_with_conditionals_executes_stop_loss() {
    ...
    let trader_conditional_orders = phoenix_rise::get_conditional_orders_address(&taker_trader);
...
fn rise_sdk_onboard_trader_delegated_ix_executes() {
    ...
    let mut set_gated_exchange_data =
        phoenix_rise::ix::compute_discriminant("global:change_exchange_status").to_vec();
    ...
    context.send_instructions(
        vec![Instruction {
            program_id: *phoenix_rise::ix::PHOENIX_PROGRAM_ID,
            accounts: vec![
...
fn create_permission_ix(payer: &Pubkey, authority: &Pubkey, user: &Pubkey) -> Instruction {
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(phoenix_rise::ix::SYSTEM_PROGRAM_ID, false),
        ],
        data: phoenix_rise::ix::compute_discriminant("global:create_permission").to_vec(),
    }
}
...
fn set_permission_ix(authority: &Pubkey, user: &Pubkey, permission: u64) -> Instruction {
    ...
    let mut data = phoenix_rise::ix::compute_discriminant("global:set_permission").to_vec();
...
fn ping_conditional_order_ix(
    ...
    Instruction {
        program_id: *phoenix_rise::ix::PHOENIX_PROGRAM_ID,
        accounts,
        data: phoenix_rise::ix::compute_discriminant("global:ping_conditional_orders").to_vec(),
    }
}
...
fn execute_conditional_order_ix(
    ...
    trigger_direction: phoenix_rise::Direction,
) -> Instruction {
    let mut accounts = vec![
        AccountMeta::new_readonly(*phoenix_rise::ix::PHOENIX_PROGRAM_ID, false),
        AccountMeta::new_readonly(*phoenix_rise::ix::PHOENIX_LOG_AUTHORITY, false),
    ...
    let mut data =
        phoenix_rise::ix::compute_discriminant("global:execute_conditional_orders").to_vec();
...
fn update_oracle_prices_with_ordering_ix(
    ...
    let mut data =
        phoenix_rise::ix::compute_discriminant("global:update_oracle_prices_with_ordering")
            .to_vec();
    data.extend_from_slice(
    ...
    Instruction {
        ...
        accounts: vec![
            AccountMeta::new_readonly(*phoenix_rise::ix::PHOENIX_PROGRAM_ID, false),
            AccountMeta::new_readonly(*phoenix_rise::ix::PHOENIX_LOG_AUTHORITY, false),
            AccountMeta::new_readonly(*phoenix_rise::ix::PHOENIX_GLOBAL_CONFIGURATION, false),
...
fn update_spline_price_ix(
    ...
    let mut data = phoenix_rise::ix::compute_discriminant("global:update_spline_price").to_vec();
    data.extend_from_slice(
