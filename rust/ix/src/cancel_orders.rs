...
use crate::types::{AccountMeta, CancelId, Instruction, Side, push_trader_index_accounts};
...
pub fn create_cancel_all_ix(params: CancelAllParams) -> Result<Instruction, PhoenixIxError> {
    ...
    Ok(Instruction {
        ...
        data: crate::PhoenixInstruction::CancelAll.discriminant().to_vec(),
    })
}
...
fn encode_cancel_up_to(params: &CancelUpToParams) -> Vec<u8> {
    ...
    data.extend_from_slice(&crate::PhoenixInstruction::CancelUpTo.discriminant());
...
fn encode_cancel_orders(params: &CancelOrdersByIdParams) -> Vec<u8> {
    ...
    data.extend_from_slice(&crate::PhoenixInstruction::CancelOrdersById.discriminant());
...
fn build_cancel_order_accounts(
    ...
    push_trader_index_accounts(&mut accounts, global_trader_index, active_trader_buffer);
...
mod tests {
    ...
    fn test_create_cancel_all_ix() {
        ...
        assert_eq!(
            &ix.data[..8],
            &crate::PhoenixInstruction::CancelAll.discriminant()
        );
    ...
    fn test_create_cancel_up_to_ix() {
        ...
        assert_eq!(
            &ix.data[..8],
            &crate::PhoenixInstruction::CancelUpTo.discriminant()
        );
