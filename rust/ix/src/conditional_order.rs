...
use crate::types::{
    AccountMeta, Direction, FifoOrderId, Instruction, Side, StopLossOrderKind,
...
impl CreateConditionalOrdersAccountParamsBuilder {
    ...
    pub fn build(self) -> Result<CreateConditionalOrdersAccountParams, PhoenixIxError> {
        ...
        let trader_conditional_orders = match self.trader_conditional_orders {
            Some(trader_conditional_orders) => trader_conditional_orders,
            None => get_conditional_orders_address(&trader_account)?,
        };
...
pub fn create_create_conditional_orders_account_ix(
    ...
    data.extend_from_slice(
        &crate::PhoenixInstruction::CreateConditionalOrdersAccount.discriminant(),
    );
    data.extend_from_slice(
...
pub fn create_place_position_conditional_order_ix(
    ...
    let mut data = Vec::new();
    data.extend_from_slice(
        &crate::PhoenixInstruction::PlacePositionConditionalOrder.discriminant(),
    );
    data.extend_from_slice(
...
pub fn create_place_attached_conditional_order_ix(
    ...
    let mut data = Vec::new();
    data.extend_from_slice(
        &crate::PhoenixInstruction::PlaceAttachedConditionalOrder.discriminant(),
    );
    data.extend_from_slice(
...
pub fn create_place_limit_order_with_conditionals_ix(
    ...
    let mut data = Vec::new();
    data.extend_from_slice(
        &crate::PhoenixInstruction::PlaceLimitOrderWithConditionals.discriminant(),
    );
    data.extend_from_slice(
...
pub fn create_cancel_conditional_order_ix(
    ...
    let mut data = Vec::new();
    data.extend_from_slice(&crate::PhoenixInstruction::CancelConditionalOrder.discriminant());
    data.extend_from_slice(
...
mod tests {
    ...
    fn test_create_conditional_orders_account_ix() {
        ...
        assert_eq!(
            ...
            get_conditional_orders_address(&trader_account).unwrap()
        );
    }
