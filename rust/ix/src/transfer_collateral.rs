...
fn encode_transfer_collateral(params: &TransferCollateralParams) -> Vec<u8> {
    ...
    data.extend_from_slice(&crate::PhoenixInstruction::TransferCollateral.discriminant());
...
pub fn create_transfer_collateral_child_to_parent_ix(
    ...
    let data = crate::PhoenixInstruction::TransferCollateralChildToParent
        .discriminant()
        .to_vec();
...
mod tests {
    ...
    fn test_create_transfer_collateral_ix() {
        ...
        assert_eq!(
            &ix.data[..8],
            &crate::PhoenixInstruction::TransferCollateral.discriminant()
        );
    ...
    fn test_create_transfer_collateral_child_to_parent_ix() {
        ...
        assert_eq!(
            &ix.data[..8],
            &crate::PhoenixInstruction::TransferCollateralChildToParent.discriminant()
        );
    }
