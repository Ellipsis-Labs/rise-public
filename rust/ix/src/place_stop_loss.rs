...
use crate::types::{
    AccountMeta, Direction, Instruction, Side, StopLossOrderKind, push_trader_index_accounts,
};
...
impl PlaceStopLossParamsBuilder {
    ...
    pub fn build(self) -> Result<PlaceStopLossParams, PhoenixIxError> {
        ...
        Ok(PlaceStopLossParams {
            ...
            stop_loss_account: match self.stop_loss_account {
                Some(stop_loss_account) => stop_loss_account,
...
fn encode_place_stop_loss(params: &PlaceStopLossParams) -> Vec<u8> {
    ...
    data.extend_from_slice(&crate::PhoenixInstruction::PlaceStopLoss.discriminant());
...
mod tests {
    ...
    fn test_create_place_stop_loss_ix() {
        ...
        assert_eq!(
            &ix.data[..8],
            &crate::PhoenixInstruction::PlaceStopLoss.discriminant()
        );
