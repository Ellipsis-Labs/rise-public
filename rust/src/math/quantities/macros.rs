...
macro_rules! basic_u64_struct_with_bounds {
    ($type_name:ident, $lower_bound:expr, $upper_bound:expr) => {
        ...
        impl $type_name {
            ...
            /// ```
            pub fn new_checked(value: u64) -> Result<Self, $crate::math::quantities::MathError> {
                if !(Self::LOWER_BOUND..=Self::UPPER_BOUND).contains(&value) {
                    Err($crate::math::quantities::MathError::out_of_bounds_u64(
                        value,
                        Self::LOWER_BOUND,
                        Self::UPPER_BOUND,
                    ))
        ...
        impl core::convert::TryFrom<u8> for $type_name {
            type Error = $crate::math::quantities::MathError;
        ...
        impl core::convert::TryFrom<u128> for $type_name {
            ...
            fn try_from(value: u128) -> Result<Self, Self::Error> {
                if value > u64::MAX as u128 {
                    return Err($crate::math::quantities::MathError::Overflow);
                }
                Self::new_checked(value as u64)
            }
        }
...
macro_rules! basic_u32_struct_with_bounds {
    ($type_name:ident, $lower_bound:expr, $upper_bound:expr) => {
        ...
        impl $type_name {
            pub fn new_checked(value: u32) -> Result<Self, $crate::math::quantities::MathError> {
                if !(Self::LOWER_BOUND..=Self::UPPER_BOUND).contains(&value) {
                    Err($crate::math::quantities::MathError::out_of_bounds_u32(
                        value,
                        Self::LOWER_BOUND,
                        Self::UPPER_BOUND,
                    ))
    ...
    ($type_name:ident) => {
        pastey::paste! {
            ...
            impl [<$type_name Upcasted>] {
                ...
                pub fn checked_as_u128(&self) -> Result<u128, $crate::math::quantities::MathError> {
                    if self.inner < 0 {
                        Err($crate::math::quantities::MathError::Underflow)
                    } else {
...
macro_rules! basic_i64_struct_with_bounds {
    ($type_name:ident, $lower_bound:expr, $upper_bound:expr) => {
        ...
        impl $type_name {
            ...
            /// ```
            pub fn new_checked(value: i64) -> Result<Self, $crate::math::quantities::MathError> {
                if !(Self::LOWER_BOUND..=Self::UPPER_BOUND).contains(&value) {
                    Err($crate::math::quantities::MathError::out_of_bounds_i64(
                        value,
                        Self::LOWER_BOUND,
                        Self::UPPER_BOUND,
                    ))
        ...
        impl core::convert::TryFrom<i128> for $type_name {
            ...
            fn try_from(value: i128) -> Result<Self, Self::Error> {
                let converted = i64::try_from(value).map_err(|_| {
                    $crate::math::quantities::MathError::out_of_bounds_i128(
                        value,
...
macro_rules! basic_i32_struct_with_bounds {
    ($type_name:ident, $lower_bound:expr, $upper_bound:expr) => {
        ...
        impl $type_name {
            ...
            /// ```
            pub fn new_checked(value: i32) -> Result<Self, $crate::math::quantities::MathError> {
                if !(Self::LOWER_BOUND..=Self::UPPER_BOUND).contains(&value) {
                    Err($crate::math::quantities::MathError::out_of_bounds_i32(
                        value,
                        Self::LOWER_BOUND,
                        Self::UPPER_BOUND,
                    ))
...
macro_rules! allow_add_64bit {
    ($unsigned_type:ident, $signed_type:ident) => {
        impl $unsigned_type {
            ...
            /// exceeds i64::MAX.
            pub fn checked_as_signed(
                &self,
            ) -> Result<$signed_type, $crate::math::quantities::MathError> {
                if self.inner <= i64::MAX as u64 {
                    Ok($signed_type::new(self.inner as i64))
                } else {
                    Err($crate::math::quantities::MathError::Overflow)
                }
            }
        }
        ...
        impl $signed_type {
            ...
            pub fn checked_as_unsigned(
                &self,
            ) -> Result<$unsigned_type, $crate::math::quantities::MathError> {
                if self.inner < 0 {
                    Err($crate::math::quantities::MathError::Underflow)
                } else if (self.inner as u64)
                    > <$unsigned_type as $crate::math::quantities::ScalarBounds<u64>>::UPPER_BOUND
                {
                    Err($crate::math::quantities::MathError::Overflow)
                } else {
