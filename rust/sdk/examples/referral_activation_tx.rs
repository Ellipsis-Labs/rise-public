...
//!     --features tx-builder,solana-keypair -- <REFERRAL_CODE> \
...
const USAGE: &str = r#"Usage:
  cargo run -p phoenix-rise --example referral_activation_tx --features tx-builder,solana-keypair -- <REFERRAL_CODE> [options]
