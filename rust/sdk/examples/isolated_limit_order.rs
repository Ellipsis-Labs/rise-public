...
//!   cargo run -p phoenix-rise --example isolated_limit_order --features
//! solana-keypair -- SOL 10 150.50 5000000 [--async]

use std::env;

use phoenix_rise::api::{PhoenixHttpClient, PhoenixWSClient, Trader, TraderKey};
use phoenix_rise::core::{PhoenixMetadata, PhoenixTxBuilder};
