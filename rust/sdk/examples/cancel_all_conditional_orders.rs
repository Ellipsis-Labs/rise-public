...
use phoenix_rise::accounts::owned::{ConditionalOrderCollection, StopLossDirection};
use phoenix_rise::api::PhoenixHttpClient;
use phoenix_rise::core::{AccountDataFetcher, FetchedAccount, PhoenixAccountClient, TraderKey};
use phoenix_rise::ix::constants::get_conditional_orders_address;
use phoenix_rise::types::ix::CancelConditionalOrderRequest;
...
fn build_asset_id_to_symbol_map(
    perp_asset_map: &phoenix_rise::accounts::owned::PerpAssetMapOwned,
) -> HashMap<u32, String> {
    perp_asset_map
        .iter()
