...
//! cargo run -p phoenix-rise --example compute_trader_margin -- <AUTHORITY_PUBKEY>
//! ```
//!
...
use phoenix_rise::math::{TraderPortfolio, TraderPortfolioMargin, WrapperNum};
use phoenix_rise::{
    ExchangeView, PhoenixHttpClient, PhoenixMetadata, PhoenixWSClient, SubaccountState, Trader,
    TraderKey,
};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let exchange: ExchangeView = exchange_response.into();
