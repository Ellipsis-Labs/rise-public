...
//!     --features solana-keypair -- <TRADER_AUTHORITY> [options]
//!
//! Options:
...
use phoenix_rise::{
    OnboardTraderDelegatedParams, PhoenixHttpClient, PhoenixMetadata, RegisterTraderParams,
    TraderKey, get_permission_address,
};
...
const USAGE: &str = r#"Usage:
  cargo run -p phoenix-rise --example onboard_trader_delegated --features solana-keypair -- <TRADER_AUTHORITY> [options]
