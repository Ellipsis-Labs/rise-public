...
use crate::types::l2book::L2Book;
use crate::types::market_stats::MarketStats;
use crate::types::{L2BookUpdate, MarketStatsUpdate, ServerMessage};
...
mod tests {
    ...
    fn make_l2_update(symbol: &str) -> L2BookUpdate {
        L2BookUpdate {
            symbol: symbol.to_string(),
            orderbook: crate::types::L2Orderbook {
